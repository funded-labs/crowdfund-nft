...
const tiers = [
  ...
  },
  {
    ...
    description: 'Internet Identity is an anonymous blockchain authentication framework supported by the Internet Computer.',
    features: [
    ...
    <div className="bg-blue-700">
      <div className="pt-12 sm:pt-16 lg:pt-24">
        <div className="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="mx-auto max-w-4xl text-center leading-6 font-semibold text-gray-100">To use CrowdFund NFT, you will need a Plug Wallet, containing ICP tokens. You may also need to set up Internet Identity, if you intend to submit a project.</h2>
          </div>
        </div>
      </div>
            ...
            <div className="rounded-lg bg-gray-100 px-6 py-8 sm:p-10 lg:flex lg:items-center">
              <div className="flex-1">
                ...
                <div className="mt-4 text-lg text-gray-600">
                  To use CrowdFund NFT, you will also need to have ICP tokens transferred to your Plug Wallet. <span className="font-semibold text-gray-900">You can buy ICP tokens on Coinbase, Binance, or any other major exchange</span>.
                </div>
              </div>
