    ...
    return (
        <section className='w-full py-20 bg-gradient-to-br from-blue-500 to-blue-600'>
            <div className='w-full max-w-5xl mx-auto flex flex-col'>
                <div className="w-full flex flex-row space-x-10 py-10">
                    <div className="w-full md:w-6/12 font-bold text-6xl text-white">
                        Crowdfunding on the <span className="underline">Blockchain</span>,
