...
const people = [
  {
    name: 'Luke Dugdale',
    role: 'CEO',
    imageUrl: 'assets/luke.png',
    twitterUrl: 'https://twitter.com/luke_icp',
    linkedinUrl: 'https://www.linkedin.com/in/luke-dugdale-71aa65113/',
  },
  {
    name: 'Mazen Zibara',
    role: 'CTO',
    imageUrl: 'assets/mazen.jpeg',
...
export default function Teamtwo() {
  return (
    <div className='bg-white'>
      <div className='mx-auto max-w-5xl py-12 px-4 sm:px-6 lg:px-8 lg:py-4'>
        <div className='space-y-12'>
          <div className='space-y-5 sm:space-y-4 md:max-w-xl lg:max-w-3xl xl:max-w-none'>
            ...
            <p className='text-xl text-gray-500'>
              A group of serial entrepreneurs, passionate about Web3 and funding
              new ventures
            </p>
          </div>
          <ul
