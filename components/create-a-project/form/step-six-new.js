            ...
            {({ handleSubmit, handleBlur, handleChange, errors, values }) => (
                <form
                    ...
                    <div className='w-full sm:flex sm:flex-row sm:grid-cols-2 space-y-1'>
                        ...
                        <p className='font-bold text-4xl sm:px-12 sm:pt-24 text-neutral-900 tracking-tight font-sans'>Submission</p>
                        <p className='font-light text-md sm:px-12 sm:pt-4 text-neutral-500 font-sans'>
                            Submission of a project is free, but this does not guarantee that your project will go
                            live on the platform.
                        </p>
                        </div>
                        <div>
                        <div className='flex-col rounded-l-3xl bg-white h-screen sm:px-36 sm:py-24 p-8 flex-1'>
                            <p className=''>
