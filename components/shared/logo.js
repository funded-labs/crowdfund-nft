export default function Logo({ width }) {
  return (
    <div className='w-25 h-8 cursor-pointer duration-200 hover:scale-105'>
      <svg
        width={width}
      ...
      >
        <g fill='none' fillRule='evenodd'>
          ...
          <circle fill='#FFF' opacity='.707' cx='116' cy='24' r='10' />
          <circle fill='#FFF' opacity='.707' cx='116' cy='126' r='10' />
          <text
