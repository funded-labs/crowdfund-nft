...
dfx canister call escrow_manager createEscrowCanister '(1, principal "6ef2j-7xajs-x476v-hn3eb-ocaib-cbhcr-pdjux-jom7m-xlc6w-df774-xae", vec {record { number=500; priceE8S=100000000; };}, 1672425906000, 5, 20)'
