            ...
            <div className='w-screen h-screen bg-white flex flex-col justify-center'>
                <div className='w-full max-w-6xl px-4 mx-auto items-center flex flex-col space-y-4'>
                    ...
                    <p className='max-w-xl text-center text-gray-500'>
                        Thank you for backing CrowdFund NFT - and investing in
                        our first live project! If the project reaches its
                        funding goal, your NFT will be transferred to your
                        wallet - if the project does not get fully funded, you
                        will be reimbursed.
                    </p>
