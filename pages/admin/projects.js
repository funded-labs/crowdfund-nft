            ...
            {projects.map(({ owner, project }) => (
              <tr key={project.id}>
                ...
                <td className='relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6'>
                  <Link
                    href={`/admin/edit-project?projectId=${project.id}`}
                    as={`/admin/edit-project.html?projectId=${project.id}`}
                  >
                  ...
                  <Link
                    ...
                    as={`/project.html?projectId=${project.id}`}
                  >
                    <a className='ml-3 text-gray-600 hover:text-gray-800'>
                      View project
                    </a>
                  </Link>
                  <Link
                    href={`/admin/conversation?principal=${owner.id.toText()}`}
                    as={`/admin/conversation.html?principal=${owner.id.toText()}`}
                  >
                    <a className='ml-3 text-gray-600 hover:text-gray-800'>
                      Message
                    </a>
