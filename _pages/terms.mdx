...
**The content of this web site is not a financial promotion under section 21 of the Financial Services and Markets Act 2000 (“FSMA”). You should note that no regulated investments of any kind are offered, marketed or distributed in any manner through the platform since we, CrowdFund NFT Limited, are not authorised or regulated to do so by the Financial Conduct Authority (as the regulatory authority in the United Kingdom responsible for authorisations under FSMA) or by any other regulatory authority in any jurisdiction outside of the United Kingdom.  Because this is a rewards-based crowdfunding site, no recourse to the Financial Ombudsman Service or the Financial Services Compensation Scheme shall be available.**

**IF YOU ARE IN ANY DOUBT ABOUT THE CONTENT OF THIS WEB SITE OR YOUR LEGAL RIGHTS OR OBLIGATIONS YOU ARE STRONGLY RECOMMENDED TO CONSULT A SOLICITOR OR OTHER SUITABLY QUALIFIED PROFESSIONAL PERSON WHO CAN ADVISE YOU ON YOUR RIGHTS AND OBLIGATIONS AS A USER.**


## 1. Welcome Information

    1.1) Welcome to CrowdFund NFT. The www.crowdfund-nft.com website (“**the Website**”) and the services provided through it are operated and owned by CrowdFund NFT (“**we**”, “**us**” or “**our**” as appropriate). For further information about us and our contact details, please visit the About Us page and see paragraph 21.2 below.
...
##6. Campaign Owners**
    ...
    6.6) Campaign Owners’ Obligations
        ...
        (a) As a Campaign Owner, you shall:
            ...
            (vi) romptly contact and work with Backers in order to reach a mutually satisfactory resolution, which may include refunding their Contributions if you are unable to fulfil any of your commitments (including providing any Rewards);
...
## 7. Backers
    ...
    (a) Each Backer shall:
        ...
        (ii) promptly respond to a Campaign Owner following a request for information reasonably required by the Campaign Owner to fulfil a Reward that you have chosen at the time you made your Contribution; and
        
        (iii) ensure that any funds used to make Contributions will not result in a breach of applicable law.
...
## 8. Additional important terms
    ...
    8.1) The contract between Campaign Owners and Backers
        ...
        (b) The following steps have to take place before a contract is made between the Backer and the Campaign Owner:
            ...
            (ii) the Backer will see an on-screen acknowledgement of their Contribution and receive an email confirming details of the Contribution made, to the email address provided by the Backer.
...
## 9. The rules for contributing content
...
## 11. Our content
    ...
    11.4) To be clear, you are not in any circumstances permitted to:
        ...
        (c) emove, obscure or otherwise tamper with any copyright and proprietary notices that relate to, or are contained within, the content.
