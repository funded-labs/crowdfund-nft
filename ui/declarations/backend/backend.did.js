export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    getMarketplaceLinks: IDL.Func([ProjectId], [MarketplaceLinks], ['query']),
    ...
    getProjectVideo: IDL.Func([ProjectId], [IDL.Opt(Link__1)], ['query']),
    getProjectWithOwner: IDL.Func([ProjectId], [ProjectWithOwner], ['query']),
